...
在創作環境中，空白一片的狀態或許是創作環境中最令人生畏的時候。在我們進入創作的狀態之中時，靈感往往接連湧出，但在毫無頭緒之時，所有的選擇都是一種可能，這反而導致你我難以抉擇。一步步來（第X頁）無疑是一種推進的方式，但推進應該從哪一步開始呢？當你一無所有的時候，即便是單單這一步也會變得像是無法逾越的障礙。
